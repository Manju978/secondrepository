...
<div id="notBar">
	<div class="bar">
		<span id="head-image"><img
			...
			id="text">Login using your id and password
			</span> <span
			...
			<div id="carousel-slider" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner">
					<div class="item active">
						<img src="resources/images/my1.jpg" class="img-responsive"
							alt="">
					</div>
					<div class="item">
						<img src="resources/images/my2.jpg" class="img-responsive"
							alt="">
					</div>
					<div class="item">
						<img src="resources/images/my3.jpg" class="img-responsive"
							alt="">
					</div>
				</div>
